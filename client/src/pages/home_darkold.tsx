      ...
      <main className="pt-24 pb-0">
        ...
        <section className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="prose prose-lg mx-auto text-muted-foreground space-y-6">
            ...
            <p>
              Y Combinator startups launch in synchronized batches, allowing models to measure relative execution and short-term outperformance, instead of waiting for distant outcomes like unico[...]
            </p>
          </div>
        </section>
